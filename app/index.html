                ...
                <nav class="navbar navbar-inverse navbar-fixed-top">
                    <div class="container-fluid">
                        ...
                        <div class="nav navbar-header">
                            ...
                            <a class="nav navbar-brand" id="sol-label" href="#">Studenti Online</a>
                            <p class="nav navbar-text" id="school-information">Ingegneria e Scienze Informatiche</p>
                            <!--Dropdown notifiche-->
                            <div class="nav navbar-nav text-center">
                                <ul class="nav navbar-nav" id="notification-button">
                                    <!--Notification bell-->
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="#notification-reference">
                                            <li><p class="dropdown-header">Notifiche</p></li>
                                            <li class="divider"></li>
                                            <li><p class="dropdown-item">Notifica 1</p></li>
                                            <li><p class="dropdown-item">Notifica 2</p></li>
                                            <li><p class="dropdown-item">Notifica 3</p></li>
                                            <li><p class="dropdown-item">Notifica 4</p></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                ...
                <div id="wrapper" class="">
                    ...
                    <div id="sidebar-wrapper">
                        ...
                        <ul class="nav sidebar-nav">
                           ...
                           <li><a href="#" id="logout-menu" data-toggle="collapse" data-target="#submenu4" aria-expanded="false">
                               Logout<span class="glyphicon glyphicon-log-out pull-right"></span></a>
			                     <ul class="nav navbar-right collapse" id="submenu4" role="menu" aria-labelledby="logout-menu">
				                    <li class="sidebar-submenu"><a href="#">Cambia corso</a></li>
				                    <li class="sidebar-submenu"><a href="#">Sospendi gli studi</a></li>
                                    <li class="sidebar-submenu"><a href="#">Rinuncia agli studi</a></li>
			                     </ul>
